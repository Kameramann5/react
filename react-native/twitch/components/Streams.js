      ...
      {channels.map((channel, index) => (
        <View key={index} style={styles.card}>
          ...
          <View style={styles.cardBody}>
            <Text style={styles.title}>{channel.user_name}</Text>
            <Text style={styles.description}>{channel.description}</Text>

            <Text style={styles.gameName}>{channel.gameName}</Text>
            <Text style={styles.viewers}>{channel.viewer_count} зрителей</Text>
            {/* <TouchableOpacity
              style={styles.button}
            ...
            >
             ...
             <TouchableOpacity
  style={styles.button}
  onPress={() => navigation.navigate('StreamerLive', { userName: channel.user_name })}
>  
<Text style={styles.buttonText}>{channel.user_name }</Text>
</TouchableOpacity>
