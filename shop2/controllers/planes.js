...
const createPlane = async (req, res) => {
  ...
  if (!req.body.capacity) {
    errors.capacity = { message: "Пожалуйста, укажите наличие" };
  }

  /*if (req.body.capacity.length > 2) {
    errors.capacity = { message: "Наличие не может быть больше 99" };
  }*/

  if (!req.file) {
    errors.planeImage = { message: "Пожалуйста, добавьте фото авто" };
  }
